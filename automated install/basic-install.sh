...
setDNS() {
  ...
  case ${DNSchoices} in
    ...
    Level3-1)
	  ...
	  Level3-2)
      echo "::: Using Level3 servers."
      PIHOLE_DNS_1="4.2.2.3"
      PIHOLE_DNS_2="4.2.2.4"
      ;;
	    Level3-3)
      echo "::: Using Level3 servers."
      PIHOLE_DNS_1="4.2.2.5"
      PIHOLE_DNS_2="4.2.2.6"
      ;;
	  Level3-4)
      echo "::: Using Level3 servers."
      PIHOLE_DNS_1="209.244.0.4"
      PIHOLE_DNS_2="209.244.0.3"
      ;;
    Norton)
    ...
    Comodo)
      ...
      ;;
	Megapath1)
	echo "::: Using Megapath PT 1 servers."
      PIHOLE_DNS_1="64.81.159.2"
      PIHOLE_DNS_2="64.81.127.2"
      ;;
	  	Megapath2)
	echo "::: Using Megapath PT 2  servers."
	  PIHOLE_DNS_1="216.231.41.2"
      PIHOLE_DNS_2="216.254.95.2"
	  
      ;;
	  Megapath3)
	echo "::: Using Megapath PT 3 servers."
	  PIHOLE_DNS_1="66.92.224.2"
      PIHOLE_DNS_2="66.92.64.2"
      ;;
	
	  Megapath4)
	echo "::: Using Megapath PT 4 servers."
	  PIHOLE_DNS_1="64.81.79.2"
      PIHOLE_DNS_2="64.81.45.2"
      ;;	
